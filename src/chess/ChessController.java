...
public class ChessController implements ChessDelegate, ActionListener {
	...
	private JTextField ipTextField;  // Khung nhập địa chỉ IP
	...
	private void runSocketClient(String ipAddress) {
		try {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == resetBtn) {
			...
			runSocketClient(ipAddress);
			JOptionPane.showMessageDialog(frame, "Connected to " + ipAddress + ":" + PORT);
		}
	}
}
